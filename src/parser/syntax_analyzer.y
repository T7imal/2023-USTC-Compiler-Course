...
| type-specifier ID LSQUARE INTEGER RSQUARE SEMICOLON {$$ = node("var-declaration", 6, $1, $2, $3, $4, $5, $6);};
...
| type-specifier ID LSQUARE RSQUARE {$$ = node("param", 4, $1, $2, $3, $4);};
...
var: ID {$$ = node("var", 1, $1);}
| ID LSQUARE expression RSQUARE {$$ = node("var", 4, $1, $2, $3, $4);};

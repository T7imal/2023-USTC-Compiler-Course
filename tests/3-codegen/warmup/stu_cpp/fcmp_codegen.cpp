...
void translate_main(CodeGen* codegen) {
    ...
    codegen->append_inst("lu12i.w $t0, 0x40160");
    codegen->append_inst("movgr2fr.w $ft0, $t0");
    // TODO: 将 1.0 (0x3f800000) 加载到浮点寄存器中
    codegen->append_inst("lu12i.w $t1, 0x3ff0");
    ...
    codegen->append_inst("sltui $t1, $t0, 1");
    codegen->append_inst("xori $t1, $t1, 1");
